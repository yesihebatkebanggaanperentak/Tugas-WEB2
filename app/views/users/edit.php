    ...
    <div class="col-md-8">
        <div class="card p-4 shadow-sm border-0">
            <div class="d-flex align-items-center justify-content-between mb-4 border-bottom pb-3">
                <h3 class="fw-bold mb-0 text-primary"><i class="bi bi-pencil-square me-2"></i> Edit Data User</h3>
            ...
            <form action="<?= BASE_URL ?>admin/users/edit/<?= $user['id'] ?>" method="POST">
                ...
                <div class="row g-3 mb-4">
                    ...
                    <div class="col-md-6">
                        <label for="password" class="form-label">Password Baru <span class="text-muted small fw-normal">(Kosongkan jika tidak diganti)</span></label>
